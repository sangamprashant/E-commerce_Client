      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/6 md:w-1/2 md:pr-16 lg:pr-5 pr-5">
            <h1 className="title-font font-medium text-3xl text-gray-900">Happy To Connect</h1>
            <p className="leading-relaxed mt-4">Discover a world of amazing products at our store. Sign up to start shopping!</p>
          </div>
          {!EnterOtp ? (
